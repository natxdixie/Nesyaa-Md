...
const playstore = 'https://play.google.com/store/apps/details?id=com.mobile.legends'
const itunes = 'https://itunes.apple.com/app/pubg-mobile-traverse/id1330123889'
...
module.exports = class Exif {
    ...
    create(packname, authorname, filename) {
        ...
        fs.writeFile(`./zenz/${filename}.exif`, buffer, (err) => {
